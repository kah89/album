...
<body>
            <header>
							<nav class="navbar navbar-expand-lg navbar-dark bg-dark ">
								...
								<a class="navbar-brand" id="titulo" href="#">Álbum</a>
								...
								<!-- <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
									<div class="dropdown">
										<button class="dropbtn">Anos 
										<i class="fa fa-caret-down"></i>
									</button>
									<div class="dropdown-content">
										<a class="nav-link active" href="#"> 2021 <span class="sr-only">(current)</span></a>
										...
										<a class="nav-link active" href="#"> 2017 <span class="sr-only">(current)</span></a>
									</div>
								</div> -->
							</nav>
